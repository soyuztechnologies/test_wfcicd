		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#atsshopworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"atsshopworkflowuimodule-display": {
								"semanticObject": "atsshopworkflowuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ats.shop.workflowuimodule",
									"url": sap.ui.require.toUrl("ats/shop/workflowuimodule")
								}
							}
						}
					}
